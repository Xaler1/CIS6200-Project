...
def main(args):
    ...
    # Change by Erik - added next 3 lines: Add text_encoder_controlnet
    text_encoder_controlnet = text_encoder_cls.from_pretrained(
        args.pretrained_model_name_or_path, subfolder="text_encoder", revision=args.revision, variant=args.variant
    )
    ...
    # Change by Erik - added next line: Set requires_grad true for text_encoder_controlnet
    text_encoder_controlnet.requires_grad_(True)
    controlnet.train()
    ...
    # Optimizer creation
    # Change by Erik - changed next line: make list of params to pass to Adam, including text_encoder_controlnet
    params_to_optimize = list(controlnet.parameters()) + list(text_encoder_controlnet.parameters())
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        for step, batch in enumerate(train_dataloader):
            with accelerator.accumulate(controlnet):
                ...
                # Change by Erik - added next line: Get embedding from text_encoder_controlnet
                encoder_hidden_states_controlnet = text_encoder_controlnet(batch["input_ids"], return_dict=False)[0]
                ...
                down_block_res_samples, mid_block_res_sample = controlnet(
                    noisy_latents,
                    timesteps,
                    # Change by Erik - changed next line: Replace embedding from text_encoder with embedding from text_encoder_controlnet
